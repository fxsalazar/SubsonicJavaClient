 ...
 * generated in the subsonicAPI.model package.
...
public class ObjectFactory {
    ...
    private final static QName _SubsonicResponse_QNAME = new QName("http://subsonic_api.org/restapi", "subsonic_api-response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: subsonicAPI.model
     */
     ...
     */
    @XmlElementDecl(namespace = "http://subsonic_api.org/restapi", name = "subsonic_api-response")
