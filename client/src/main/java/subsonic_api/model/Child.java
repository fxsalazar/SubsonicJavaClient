...
public class Child {
    ...
    @Attribute(name = "isDir", required = true)
    protected boolean isDir;
    @Attribute(name = "title", required = true)
    protected String title;
    @Attribute(required = false, name = "album")
    protected String album;
    @Attribute(required = false, name = "artist")
    protected String artist;
    @Attribute(required = false, name = "track")
    protected Integer track;
    @Attribute(required = false, name = "year")
    protected Integer year;
    @Attribute(required = false, name = "genre")
    protected String genre;
    @Attribute(required = false, name = "coverArt")
    protected String coverArt;
    @Attribute(required = false, name = "size")
    protected Long size;
    @Attribute(required = false, name = "contentType")
    protected String contentType;
    @Attribute(required = false, name = "suffix")
    protected String suffix;
    @Attribute(required = false, name = "transcodedContentType")
    protected String transcodedContentType;
    @Attribute(required = false, name = "transcodedSuffix")
    protected String transcodedSuffix;
    @Attribute(required = false, name = "duration")
    protected Integer duration;
    @Attribute(required = false, name = "bitRate")
    protected Integer bitRate;
    @Attribute(required = false, name = "path")
    protected String path;
    @Attribute(required = false, name = "isVideo")
    ...
    @Attribute(required = false, name = "discNumber")
    protected Integer discNumber;
    // TODO: 08/05/2017 change to date
    @Attribute(required = false, name = "created")
    ...
    @Attribute(required = false, name = "albumId")
    protected String albumId;
    @Attribute(required = false, name = "artistId")
    protected String artistId;
    @Attribute(required = false, name = "type")
    protected MediaType type;
    @Attribute(required = false, name = "bookmarkPosition")
    protected Long bookmarkPosition;
    @Attribute(required = false, name = "originalWidth")
    protected Integer originalWidth;
    @Attribute(required = false, name = "originalHeight")
